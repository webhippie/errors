...
* **patch:** update golang docker tag to v1.26.4 ([#254](https://github.com/webhippie/errors/issues/254)) ([948d4cb](https://github.com/webhippie/errors/commit/948d4cbc14b0c6a7f4e2f3fdb38ac2bc7794a175))

### Miscellaneous

* **flake:** updated lockfile [skip ci] ([090ea04](https://github.com/webhippie/errors/commit/090ea04ddaf152ea0efff5a8283d5af8428be31d))
* **flake:** updated lockfile [skip ci] ([424e05b](https://github.com/webhippie/errors/commit/424e05b819df34edf26bab6b9f1e4f1e7b7b02a6))
...
* **patch:** update module github.com/rs/zerolog to v1.35.1 ([#246](https://github.com/webhippie/errors/issues/246)) ([f80a3f4](https://github.com/webhippie/errors/commit/f80a3f40e63a5a20c9d7dd2445e980797e23f6b0))

### Miscellaneous

* **flake:** updated lockfile [skip ci] ([655ad34](https://github.com/webhippie/errors/commit/655ad34b58b638a3a90271e10872787dc21f3806))

## [2.4.1](https://github.com/webhippie/errors/compare/v2.4.0...v2.4.1) (2026-04-20)

### Bugfixes

* **deps:** update alpine:3.23 docker digest to 5b10f43 ([#245](https://github.com/webhippie/errors/issues/245)) ([280cccc](https://github.com/webhippie/errors/commit/280cccc7f04e8bb87b981c7ea8f4c89d85a7091e))

### Miscellaneous

* **flake:** updated lockfile [skip ci] ([b2f5422](https://github.com/webhippie/errors/commit/b2f542216e1b4d41e40b2857b2cfc717ae65cc1b))
* **flake:** updated lockfile [skip ci] ([ac59241](https://github.com/webhippie/errors/commit/ac592414711fdfaa8737b9c094dc6e0540e7031f))
* **flake:** updated lockfile [skip ci] ([ed1ee5c](https://github.com/webhippie/errors/commit/ed1ee5c2b0153223d8573d1da346f6b1b8c2b985))
...
* **patch:** update module github.com/go-chi/chi/v5 to v5.2.5 ([#233](https://github.com/webhippie/errors/issues/233)) ([3f7f923](https://github.com/webhippie/errors/commit/3f7f9234d701c4a7c2a01546656c4ae57e8ce434))

### Miscellaneous

* **flake:** updated lockfile [skip ci] ([9027226](https://github.com/webhippie/errors/commit/9027226621c3e1c5f4dd84819edebf26b816e17f))

## [2.3.3](https://github.com/webhippie/errors/compare/v2.3.2...v2.3.3) (2026-02-02)

### Bugfixes

* **deps:** update alpine:3.23 docker digest to 2510918 ([#230](https://github.com/webhippie/errors/issues/230)) ([7b45033](https://github.com/webhippie/errors/commit/7b450337c69da245069f7b45fcef9882a067f481))

### Miscellaneous

* **flake:** updated lockfile [skip ci] ([c31ce10](https://github.com/webhippie/errors/commit/c31ce107ca12d413326a2e4365c9287045947d98))
* **flake:** updated lockfile [skip ci] ([9d314f4](https://github.com/webhippie/errors/commit/9d314f447982abf92632307238fbabd9560ffec7))
...
* **deps:** update golang:1.25.4-alpine3.21 docker digest to 3289aac ([#195](https://github.com/webhippie/errors/issues/195)) ([3bb2447](https://github.com/webhippie/errors/commit/3bb24477f59cd33beee59d874e9e1fa3452ef8c1))
* **patch:** update golang docker tag to v1.25.4 ([#194](https://github.com/webhippie/errors/issues/194)) ([aa12242](https://github.com/webhippie/errors/commit/aa12242bc37a24576d76d306d18be95edcff5ead))
* **patch:** update module github.com/golangci/golangci-lint/v2 to v2.6.1 ([#191](https://github.com/webhippie/errors/issues/191)) ([0e3ff76](https://github.com/webhippie/errors/commit/0e3ff76c8ef8e2b509582d9f5487183a687f98a0))

## [2.2.0](https://github.com/webhippie/errors/compare/v2.1.2...v2.2.0) (2025-11-03)


### Features

* **minor:** update module github.com/golangci/golangci-lint/v2 to v2.6.0 ([#190](https://github.com/webhippie/errors/issues/190)) ([a06b7af](https://github.com/webhippie/errors/commit/a06b7af01c8752182d96cf2f63e1b60173221fef))

## [2.1.2](https://github.com/webhippie/errors/compare/v2.1.1...v2.1.2) (2025-10-20)


### Bugfixes

* **deps:** update golang:1.25.3-alpine3.21 docker digest to 0c9f3e0 ([#186](https://github.com/webhippie/errors/issues/186)) ([7c8e7a6](https://github.com/webhippie/errors/commit/7c8e7a643919b096789a2119dec1cd67a8fe2be0))
* **patch:** update golang docker tag to v1.25.3 ([#183](https://github.com/webhippie/errors/issues/183)) ([e045eb5](https://github.com/webhippie/errors/commit/e045eb58e337d32907690a03e34f73daf65498fc))
